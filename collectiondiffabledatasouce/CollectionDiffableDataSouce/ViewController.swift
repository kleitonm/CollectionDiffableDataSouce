...
class ViewController: UIViewController {
    ...
    func createDownloadSection() -> NSCollectionLayoutSection {
        ...
        let layoutGrop = NSCollectionLayoutGroup.vertical(layoutSize: groupSize, subitems: [layoutItem])
        let layoutSectiom = NSCollectionLayoutSection(group: layoutGrop)
        layoutSectiom.orthogonalScrollingBehavior = .groupPagingCentered
        
        let sectionHeader = createSectionHeader()
        layoutSectiom.boundarySupplementaryItems = [sectionHeader]
        
        return layoutSectiom
